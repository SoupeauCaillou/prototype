...
void EquipmentStateManager::willEnter(State::Enum from) {
    ...
    Vector2 size(theRenderingSystem.screenW / 8, -theRenderingSystem.screenH / 6);
    Vector2 offset = Vector2(-theRenderingSystem.screenW * 0.5, theRenderingSystem.screenH * 0.5) + size * 0.5;
