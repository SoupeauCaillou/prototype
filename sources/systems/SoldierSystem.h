...
struct SoldierComponent {
    SoldierComponent() :player(0), apIndicator(0), moveRange(4), attackRange(1, 5), attackDamage(1), pLance(0), defensePoint(0), maxActionPointsPerTurn(5), actionPointsLeft(0) {
    }
